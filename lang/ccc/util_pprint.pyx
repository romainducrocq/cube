from ccc.abc_builtin_ast cimport AST, TIdentifier, TInt, TLong, TUInt, TULong, TDouble, ast_iter_fields #
#
...
#
    ...
    elif isinstance(_child_node, TUInt): #
        pretty_string += str(_child_node.uint_t) + '\n' #
    elif isinstance(_child_node, TULong): #
        pretty_string += str(_child_node.ulong_t) + '\n' #
    elif isinstance(_child_node, TDouble): #
        pretty_string += str(_child_node.double_t) + '\n' #
    else: #
...
cdef void _ast_pretty_string_child(str _child_kind, object _child_node): #
    ...
    global indent #
#
    if type(_child_node) in (TIdentifier, TInt, TLong, TUInt, TULong, TDouble, bool, type(None)): #
